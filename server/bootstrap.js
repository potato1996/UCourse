    ...
    if((uc_course.find().count() ===0))
        {
            ...
            uc_student_rl_course.insert({student_id:"N4Kaj5PhB8FW2TDCm",course_id:temp_course_id});
            uc_student_rl_course.insert({student_id:"N4Kaj5PhB8FW2TDCm",course_id:temp_course_id}); //zzw
